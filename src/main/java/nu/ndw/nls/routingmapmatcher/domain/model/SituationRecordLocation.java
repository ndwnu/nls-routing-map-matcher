...
public class SituationRecordLocation {
  ...
  public SituationRecordLocation(final int situationRecordId, final int locationIndex, final Point locationForDisplay) {
  ...
  public SituationRecordLocation(final int situationRecordId, final int locationIndex, final Point startPoint,
