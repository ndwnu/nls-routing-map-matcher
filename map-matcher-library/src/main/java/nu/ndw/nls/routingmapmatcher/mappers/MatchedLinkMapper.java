 ...
 * {@link List of {@link MatchedLink}. The start fraction of the leg is applied to the first link and the end fraction is applied to the
 * last link. All other fractions are either 0 for start and 1 for end as they are fully routed from start to end.
 */
@Component
public class MatchedLinkMapper {
    ...
    public List<MatchedLink> map(
            List<MatchedEdgeLink> matchedEdgeLinks,
