...
public class ViterbiLinestringMapMatcherFactory implements MapMatcherFactory<ViterbiLineStringMapMatcher> {
    ...
    public ViterbiLineStringMapMatcher createMapMatcher(NetworkGraphHopper preInitializedNetwork, String profileName) {
        return new ViterbiLineStringMapMatcher(pMapMapper, preInitializedNetwork, profileName, geometryFactoryWgs84,
                fractionAndDistanceCalculator, pointListUtil, lineStringReliabilityCalculator, null);
    }
    ...
    public ViterbiLineStringMapMatcher createMapMatcher(NetworkGraphHopper preInitializedNetwork, String profileName,
        ...
        return new ViterbiLineStringMapMatcher(pMapMapper, preInitializedNetwork, profileName, geometryFactoryWgs84,
                fractionAndDistanceCalculator, pointListUtil, lineStringReliabilityCalculator, customModel);
    }
