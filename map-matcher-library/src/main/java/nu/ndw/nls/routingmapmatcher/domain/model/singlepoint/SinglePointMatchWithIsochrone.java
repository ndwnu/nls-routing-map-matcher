...
public class SinglePointMatchWithIsochrone extends MapMatch {
    ...
    @EqualsAndHashCode
    @ToString
    public static class CandidateMatchWithIsochrone {
    ...
    private final List<CandidateMatchWithIsochrone> candidateMatches;
