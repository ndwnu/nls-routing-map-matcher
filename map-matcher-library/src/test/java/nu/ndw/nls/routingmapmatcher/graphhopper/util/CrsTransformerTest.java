...
class CrsTransformerTest {
    ...
    private final GeometryFactory wgs84GeometryFactory = new GeometryFactory(new PrecisionModel(),
            GlobalConstants.WGS84_SRID);
    private final GeometryFactory rdNewGeometryFactory = new GeometryFactory(new PrecisionModel(),
