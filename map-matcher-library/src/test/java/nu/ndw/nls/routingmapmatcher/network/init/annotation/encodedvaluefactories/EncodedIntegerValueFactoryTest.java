...
class EncodedIntegerValueFactoryTest {
    ...
    private final EncodedIntegerValueFactory encodedIntegerValueFactory = new EncodedIntegerValueFactory();

    @Test
    void getType() {
        assertEquals(Integer.class, encodedIntegerValueFactory.getType());
    }
    ...
    private void encode(boolean directional) {
        ...
        EncodedValue encode = encodedIntegerValueFactory.encode(encodedValueDto);
